...
import { ArrowLeft, HomeFilled, User, List, Tickets, Goods } from '@element-plus/icons-vue'
...
const menus = [
  ...
  { path: '/admin/task-templates', label: '任务模板', icon: List },
  { path: '/admin/products', label: '商品管理', icon: Goods },
  { path: '/admin/redemption', label: '兑换审核', icon: Tickets },
]
